...
var 简介规则=".c(<font color='blue'><b>).xml(dt).t().ct(</b></font>)";
var 图片底部规则=".xml(last).t()";
var 左上规则=".tx(<p style='background-color:blue'><font color='white' size='40px'>).xml(type).t().ct(</font></p>)";
...
var 标题规则=".json(vod_name)";var 地址规则=".c(?ac=videolist&ids=).json(vod_id)";var 图片规则=".json(vod_pic)";var 简介规则=".c(<font color='blue'><b>).json(vod_play_from).ct(</b></font>)";var 图片底部规则=".json(vod_addtime)";var 左上规则=".tx(<p style='background-color:blue'><font color='white' size='40px'>).json(type_name).ct(</font></p>)";var 右上规则=".tx(<p style='background-color:#CC00FF'><font color='white'>).json(vod_type).ct(</font></p>)";通用列表();
}else if(baseURL.indexOf("?")!=-1){
var 列表=e2Arr(源码.replace(/<.*?>/g,""),".json(list)");
var 标题规则=".json(vod_name)";var 地址规则=".c(&ac=videolist&ids=).json(vod_id)";var 图片规则=".json(vod_pic)";var 简介规则=".c(<font color='blue'><b>).json(vod_play_from).ct(</b></font>)";var 图片底部规则=".json(vod_time)";var 左上规则=".tx(<p style='background-color:blue'><font color='white' size='40px'>).json(type_name).ct(</font></p>)";var 右上规则=".tx(<p style='background-color:#CC00FF'><font color='white'>).json(vod_remarks).ct(</font></p>)";通用列表();
}else{
      if(baseURL.indexOf("/videos")!=-1){
      var 列表=e2Arr(源码.replace(/<.*?>/g,""),".json(list)");
var 标题规则=".json(vod_name)";var 地址规则=".c(?ac=detail&ids=).json(vod_id)";var 图片规则=".json(vod_pic)";var 简介规则=".c(<font color='blue'><b>).json(vod_play_from).ct(</b></font>)";var 图片底部规则=".json(vod_time)";var 左上规则=".tx(<p style='background-color:blue'><font color='white' size='40px'>).json(type_name).ct(</font></p>)";var 右上规则=".tx(<p style='background-color:#CC00FF'><font color='white'>).json(vod_remarks).ct(</font></p>)";通用列表();   
      }else{
      var 列表=e2Arr(源码.replace(/<.*?>/g,""),".json(list)");
var 标题规则=".json(vod_name).or().json(art_name)";var 地址规则=".c(?ac=videolist&ids=).json(vod_id).or().json(art_id)";var 图片规则=".json(vod_pic).or().json(art_pic)";var 简介规则=".c(<font color='blue'><b>).json(vod_play_from).ct(</b></font>).or().json(art_from).ct(</b></font>)";var 图片底部规则=".json(vod_time).or().json(art_time)";var 左上规则=".tx(<p style='background-color:blue'><font color='white' size='40px'>).json(type_name).ct(</font></p>)";var 右上规则=".tx(<p style='background-color:#CC00FF'><font color='white'>).json(vod_remarks).ct(</font></p>).or().json(vod_remark).ct(</font></p>).or().json(art_remarks).ct(</font></p>)";通用列表();
      }
}
######选集列表3
var URL=getVar("地址");
