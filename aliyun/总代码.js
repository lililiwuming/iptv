...
var device_id=ALICOOKIE.match(/device_id=(.*?)[\s;]/)[1];
    ...
    JSON.stringify([{name:"原始文件",url:playurl,head:{"Referer":"https://www.aliyundrive.com/"}}]);
        ...
        JSON.stringify([{name:"原画",url:playurl.replace(/callback=.+?&/g,""),head:{"Referer":"https://www.aliyundrive.com/"}},{name:"本地1080P转码",url:本地转码1080},{name:"720P转码",url:转码720},{name:"1080P转码",url:转码1080},{name:"本地原画",url:云端原画}]);
        //JSON.stringify([{name:"原始文件",url:playurl,head:{"Referer":"https://www.aliyundrive.com/"}}]);
    }
}else{
    alert("登陆已过期，请重新在m浏览器登陆");
