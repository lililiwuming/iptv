...
},*/
{
    ...
    "rule":{
        ...
        "列表规则":'var 列表=e2Arr(getCode(),".get(div.row div[class~=col-lg-1-5.+])");var 地址规则=".get(h2 a).a(href)";var 标题规则=".c([).get(span.meta-category).t().c(]).get(h2 a).a(title)";var 图片规则=".get(img).a(data-src)";var 简介规则=".c(更新时间:).get(time).t()";var NEXTPAGE="";var PREPAGE="";',
