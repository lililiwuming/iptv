...
"https://ccavb.tv";
###首页地址
getVar("baseURL")+"/_next/data/bRt1QhxbObOdGNyJFzH99/zh.json";
###分类地址
getVar("baseURL")+"/_next/data/bRt1QhxbObOdGNyJFzH99/zh/category/分类/翻页.json";
###搜索地址
getVar("baseURL")+"/_next/data/bRt1QhxbObOdGNyJFzH99/zh/search/关键字/翻页.json";
###rule
##首页规则
var 列表=e2Arr(getVar("源码"),".z(\\{\"aneID\":.+?\\})");var 标题规则=".json(videoName)";var 地址规则=".c(https://ccavb.tv/_next/data/bRt1QhxbObOdGNyJFzH99/zh/video/).json(aneID).ct(.json)";var 图片规则="@js=var id=JSON.parse(CODE).aneID;var 前=id.split('-')[0];var 后=id.split('-')[1];if(id.indexOf('FC2-')==0){'https://ccavb.tv/static/img/'+前+'/'+后.substr(0,2)+'/'+后+'/'+id+'_1.jpg'}else{'https://ccavb.tv/static/img/'+前+'/'+后+'/'+id+'_1.jpg'}";var 简介规则=".json(videoType)";var 图片底部规则=".json(airDate)";var 左上规则="";var 右上规则="";var NEXTPAGE="";var PREPAGE="";
##筛选数据
