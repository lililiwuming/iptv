...
"翻页"+b;
##免嗅探规则
JSON.stringify({name:"地址",url:getVar("地址")+"&_type=.m3u8",head:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36 Edg/105.0.1343.33","Referer":"http://ccavb.tv/","Origin":"http://ccavb.tv"}});
####
